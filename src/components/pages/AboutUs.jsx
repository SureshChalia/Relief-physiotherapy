            ...
            <div className="w-full max-w-7xl px-4 md:px-5 lg:px-5 mx-auto">
                <div className="w-full justify-start items-center xl:gap-12 gap-10 grid lg:grid-cols-2 grid-cols-1">
                    <div className="w-full flex-col justify-center lg:items-start items-center gap-10 inline-flex">
                        <div className="w-full flex-col justify-center items-start gap-8 flex">
                            <div className="flex-col justify-start lg:items-start items-center gap-2 flex">
                                ...
                                <div className="w-full flex-col justify-start lg:items-start items-center gap-2 flex">
                                    ...
                                    <p className="text-gray-500 text-base font-normal leading-relaxed lg:text-start text-center">Our approach combines hands-on manual therapy, state-of-the-art equipment, and patient education to promote long-term recovery and overall well-being. We believe in not just treating the symptoms but addressing the root causes of discomfort to help our patients lead healthier, more active lives.</p>
                                    <p className="text-gray-500 text-base font-normal leading-relaxed lg:text-start text-center">Whether you're an athlete recovering from injury, someone dealing with chronic pain, or simply seeking to improve your physical health, we are here to guide and support you every step of the way. At Relief physiotherapy & rehabilitation clinic, your recovery is our priority. Let us help you move better, feel better, and live better.</p>
                                </div>
                            </div>
                        ...
                        <Link to={"/contact-us"} className="sm:w-fit w-full group px-3.5 py-2 bg-indigo-50 hover:bg-indigo-100 rounded-lg shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] transition-all duration-700 ease-in-out justify-center items-center flex">
                ...
                <div className="flex sm:flex-row flex-col mt-10">
                    <div>
                        <h2 className="text-indigo-900 text-4xl font-bold font-manrope leading-normal lg:text-start text-center">Mission</h2>
                    ...
                    <div>
                        <h2 className="text-indigo-900 text-4xl font-bold font-manrope leading-normal lg:text-start text-center">Vision</h2>
