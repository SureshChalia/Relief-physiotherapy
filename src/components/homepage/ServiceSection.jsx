...
const ServiceSection = () => {
    return (
        <section className=" pb-5  lg:pb-[90px] max-w-7xl w-11/12 mx-auto">
            <div className="container mx-auto">
                ...
                <div className="-mx-4 flex flex-wrap mt-10">
                    <ServiceCard
                        ...
                        details="Effective treatment for back pain focusing on strengthening and flexibility to alleviate discomfort and enhance mobility."
                        icon={
                            <svg
                                width="36"
                                height="36"
                            ...
                            // <img src={backpain} width={46} height={46} alt="" />
                        }
                        backgroundImage={back}
                    />
                    <ServiceCard
                        title="Cervical Pain Management"
                        details="Specialized techniques to address neck pain, aimed at relieving tension and restoring normal range of motion"
                        icon={
                            <svg
                                width="36"
                                height="36"
                    ...
                    <ServiceCard
                        ...
                        details="Targeted exercises and modalities designed to alleviate shoulder pain and improve joint function and stability."
                        icon={
                            <svg
                                width="36"
                                height="36"
                    ...
                    <ServiceCard
                        ...
                        details="Comprehensive treatment for elbow pain that includes strength training and mobility exercises to promote healing."
                        icon={
                            <svg
                                width="36"
                                height="36"
                    ...
                    <ServiceCard
                        ...
                        details="Tailored therapy following surgery to facilitate recovery, restore function, and minimize complications during the healing process."
                        icon={
                            <svg
                                width="36"
                                height="36"
                    ...
                    <ServiceCard
                        ...
                        details="Comprehensive approaches to manage facial pain, integrating massage, exercises, and modalities for pain reduction."
                        icon={
                            <svg
                                width="36"
                                height="36"
                    ...
                    <ServiceCard
                        ...
                        details="Specialized treatment for paralysis, focusing on regaining movement and functionality through targeted exercises and support."
                        icon={
                            <svg
                                width="36"
                                height="36"
                    ...
                    <ServiceCard
                        ...
                        details="Hands-on techniques aimed at relieving pain and improving function in the hands, promoting recovery from injuries."
                        icon={
                            <svg
                                width="36"
                                height="36"
                    ...
                    <ServiceCard
                        ...
                        details="Treatment strategies focused on alleviating belly pain and strengthening core muscles to enhance overall stability and comfort."
                        icon={
                            <svg
                                width="36"
                                height="36"
...
const ServiceCard = ({ icon, title, details, backgroundImage }) => {
    return (
        <>
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                <div
                    className="mb-9 rounded-[20px] p-10 shadow-2 shadow-lg md:px-7 xl:px-10 transition-transform duration-500 ease-in-out transform hover:scale-110 "
                    style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
                >
                    <div className="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl opacity-80">
                        {/* {icon} */}
                    </div>
                    <h4 className="mb-[10px] text-2xl font-bold text-blue-900">
                        {title}
                    </h4>
